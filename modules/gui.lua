pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    CreateGUIEntry(T["About"], nil, function()
      ...
      this.edition = this:CreateFontString("Status", "LOW", "GameFontWhite")
      this.edition:SetFont(pfUI.font_default, C.global.font_size)
      this.edition:SetPoint("TOPLEFT", 200, -185)
      this.edition:SetPoint("TOPRIGHT", 375, -185)
      this.edition:SetJustifyH("CENTER")
      this.edition:SetTextColor(.2,1,.8)
      this.edition:SetText("USS Enterprise Edition")

      this.update = this:CreateFontString("Status", "LOW", "GameFontWhite")
      this.update:SetFont(pfUI.font_default, C.global.font_size)
      this.update:SetPoint("TOPLEFT", 200, -155)
      this.update:SetPoint("TOPRIGHT", 375, -155)
      ...
      this.screenc:SetPoint("TOPLEFT", 200, -215)
      ...
      this.screen:SetPoint("TOPRIGHT", 375, -215)
      ...
      this.scalec:SetPoint("TOPLEFT", 200, -235)
      ...
      this.scale:SetPoint("TOPRIGHT", 375, -235)
      ...
      this.clientc:SetPoint("TOPLEFT", 200, -265)
      ...
      this.client:SetPoint("TOPRIGHT", 375, -265)
      ...
      this.langc:SetPoint("TOPLEFT", 200, -285)
      ...
      this.lang:SetPoint("TOPRIGHT", 375, -285)
      ...
      donate:SetPoint("TOPLEFT", 130, -350)
      donate:SetWidth(100)
      donate:SetHeight(20)
      ...
      github:SetPoint("TOPLEFT", 240, -350)
      github:SetWidth(100)
      github:SetHeight(20)
      github:SetText(T["GitHub"])
      github:SetScript("OnClick", function()
        pfUI.chat.urlcopy.CopyText("https://github.com/USS-Enterprise-Guild/pfUI")
      end)
      SkinButton(github)

      local website = CreateFrame("Button", nil, this)
      website:SetPoint("TOPLEFT", 350, -350)
